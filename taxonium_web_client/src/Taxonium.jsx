...
function Taxonium({
  ...
  return (
    <div className="flex-grow overflow-hidden flex flex-col md:flex-row">
      <div className="h-1/2 md:h-full w-full md:w-2/3 lg:w-2/3 md:flex-grow">
        <Deck
      ...
      <SearchPanel
        className="flex-grow min-h-0 h-1/2 md:h-full md:w-1/3 lg:w-1/3 bg-white shadow-xl border-t md:border-0 overflow-y-auto md:overflow-hidden"
        backend={backend}
        search={search}
        colorBy={colorBy}
        colorHook={colorHook}
