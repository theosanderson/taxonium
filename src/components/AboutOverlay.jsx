  ...
  return (
    <div className={`w-full ${enabled ? "" : "hidden"}`}>
      ...
      <div className="fixed m-10 p-5 bg-white shadow-md z-50 w-4/5 ">
        ...
        <p>This website would not exist without the hard work of these scientists, and their openness in submitting to public databases, and we gratefully acknowledge this.</p>
