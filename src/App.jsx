...
<div className="m-10">
    ...
    or <a className="text-blue-500" href="/?protoUrl=https://hgwdev.gi.ucsc.edu/~angie/UShER_SARS-CoV-2/public-latest.all.masked.taxonium.pb.gz">load the public SARS-CoV-2 tree</a>.
    </p> </div>
}
        </Suspense>
      </div>
