...
or download that file and instead run:

`docker run -p 80:80 -e "DATA_FILE=./latest_public.jsonl.gz" -e "CONFIG_JSON=config_public.json" theosanderson/taxonium_backend:master`
