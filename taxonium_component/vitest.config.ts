...
import viteConfig from "./vite.config.ts"; // Your existing Vite configuration
...
export default mergeConfig(
  ...
  defineConfig({
    test: {
      ...
      // which are inherited from your main vite.config.ts.
    ...
    // The `build` configuration from your `vite.config.ts` is for your library build
