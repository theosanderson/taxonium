"use strict";
(self["webpackChunktaxonium"] = self["webpackChunktaxonium"] || []).push([["node_modules_jbrowse_plugin-alignments_esm_LinearPileupDisplay_components_SetMaxHeight_js"],{

/***/ "./node_modules/@jbrowse/plugin-alignments/esm/LinearPileupDisplay/components/SetMaxHeight.js":
/*!****************************************************************************************************!*\
  !*** ./node_modules/@jbrowse/plugin-alignments/esm/LinearPileupDisplay/components/SetMaxHeight.js ***!
  \****************************************************************************************************/
...
function SetMaxHeightDlg(props) {
    ...
    const [max, setMax] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(`${maxHeight}`);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_2__["default"], { open: true, onClose: handleClose },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], null,
            "Filter options",
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__["default"], { "aria-label": "close", className: classes.closeButton, onClick: handleClose },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_Close__WEBPACK_IMPORTED_MODULE_5__["default"], null))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_6__["default"], { className: classes.root },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_7__["default"], null, "Set max height for the track. For example, you can increase this if the layout says \"Max height reached\""),
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__["default"], null,
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_10__["default"], { variant: "contained", color: "primary", type: "submit", autoFocus: true, onClick: () => {
                        model.setMaxHeight(max !== '' && !Number.isNaN(+max) ? +max : undefined);
                        handleClose();
                    } }, "Submit"),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_10__["default"], { variant: "contained", color: "secondary", onClick: () => handleClose() }, "Cancel")))));
}
/* harmony default export */ __webpack_exports__["default"] = ((0,mobx_react__WEBPACK_IMPORTED_MODULE_11__.observer)(SetMaxHeightDlg));
//# sourceMappingURL=SetMaxHeight.js.map

/***/ })

}]);
//# sourceMappingURL=node_modules_jbrowse_plugin-alignments_esm_LinearPileupDisplay_components_SetMaxHeight_js.bundle.js.map